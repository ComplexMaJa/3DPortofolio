      ...
      <div className="relative aspect-[4/5] w-full max-w-[420px] rounded-[36px] border border-white/10 bg-gradient-to-br from-white/5 to-white/0 shadow-neon backdrop-blur">
        <div className="absolute inset-2 rounded-[28px] bg-black/80 p-4">
          ...
          >
            ...
            >
              <div className="flex h-full w-full items-center justify-center rounded-[24px] border border-dashed border-white/10 bg-black/40 text-xs uppercase tracking-[0.35em] text-white/40">
                Loading 3D preview…
              </div>
            </Spline>
          </SplineErrorBoundary>
