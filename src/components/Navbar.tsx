...
function Navbar({ links }: NavbarProps) {
  return (
    <header className="flex items-center justify-between">
      ...
      <button className="hidden rounded-full border border-white/20 bg-white px-6 py-2 text-sm font-semibold uppercase tracking-[0.3em] text-black transition hover:shadow-[0_0_25px_rgba(255,255,255,0.25)] md:inline-flex">
        Download Résumé
      </button>
    </header>
  )
